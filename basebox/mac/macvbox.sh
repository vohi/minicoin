...
VBoxManage setextradata $1 "VBoxInternal/Devices/efi/0/Config/DmiSystemProduct" "iMac19,3"
...
VBoxManage setextradata $1 "VBoxIntenral/Devices/smc/0/Config/GetKeyFromRealSMC" 1
